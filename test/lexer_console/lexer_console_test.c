...
FILE* lex_error_get_expected_out(int test_num){
	...
	snprintf(expected_out_filename, sizeof(expected_out_filename), "test/lexer_console/expected_out/expected_out%d.txt", test_num);
...
FILE* lex_error_get_actual_out(int test_num){
	...
	snprintf(actual_out_filename, sizeof(actual_out_filename), "test/lexer_console/actual_out/actual_out%d.txt", test_num);
	FILE* actual_out = freopen(actual_out_filename, "w+", stderr);


	char input_filename[256];
	snprintf(input_filename, sizeof(input_filename), "test/lexer_console/input/input%d.c", test_num);
